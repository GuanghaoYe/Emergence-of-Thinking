...
if [ "$NODE_RANK" -eq 0 ]; then
   ...
   -- python3 -m openrlhf.cli.train_ppo_ray \
    $node_setup \
   --colocate_actor_ref \
   --pretrain /mnt/data/huinan/openrlhf/sft/gghfez_QwQ_LongCoT_130K_cleaned/llama_3p2_3b_instruct/checkpoint2 \
   --save_path /mnt/data/openrlhf/ppo/llama_3p2_3b_instruct/checkpoint1 \
   ...
   --init_kl_coef 0.05 \
   --save_steps 40 \
   --prompt_data /mnt/data/huinan/openrlhf/sft/gghfez_QwQ_LongCoT_130K_cleaned/llama_3p2_3b_instruct/checkpoint2/data/math_formatted_sft_only_incorrect_by_sft_epoch3_temp0p7_noasy.jsonl \
   --input_key input \
   --normalize_reward \
   --packing_samples \
   --note "Pub+Gen" \
