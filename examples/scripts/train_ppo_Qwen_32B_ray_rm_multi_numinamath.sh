...
if [ "$NODE_RANK" -eq 0 ]; then
  ...
  #   done
   ...
   --save_path /mnt/data/openrlhf/ppo/numinamath/checkpoint_32b \
   ...
   --init_kl_coef 0.05 \
   --save_steps 40 \
   --prompt_data /mnt/data/huinan/openrlhf/numinamath_hard_formatted_qwen.jsonl \
   --input_key input \
   --normalize_reward \
   --packing_samples \
   --note "numinamath_hard_run_qwen_32b" \
   --flash_attn \
