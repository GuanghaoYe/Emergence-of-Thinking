...
if [ "$NODE_RANK" -eq 0 ]; then
  ...
  #   done
   ...
   -- python3 -m openrlhf.cli.train_ppo_ray \
    $node_setup \
   --colocate_actor_ref \
   --pretrain /mnt/data/huinan/openrlhf/sft/checkpoint1 \
   --save_path /mnt/data/openrlhf/ppo/numinamath/checkpoint1 \
   ...
   --init_kl_coef 0.05 \
   --save_steps 20 \
   --prompt_data /mnt/data/huinan/openrlhf/numinamath_formatted_sft.jsonl \
   --input_key input \
   --normalize_reward \
   --packing_samples \
   --note "numinamath_run_1" \
   --flash_attn \
