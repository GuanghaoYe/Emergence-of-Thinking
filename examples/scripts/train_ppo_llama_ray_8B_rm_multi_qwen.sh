...
if [ "$NODE_RANK" -eq 0 ]; then
  ...
  #   done
   ...
   --save_path /mnt/data/openrlhf/ppo/qwen_2p5_math_7b/base_no_length_penalty2 \
   ...
   --init_kl_coef 0.05 \
   --save_steps 40 \
   --prompt_data /mnt/data/huinan/openrlhf/math_level345_formatted_qwen.jsonl \
   --input_key input \
   --normalize_reward \
   --packing_samples \
   --note "Qwen2.5-Math-7B-math_level345" \
   --flash_attn \
